...
use iggyvolz\yingadb\Condition\Resolved\ResolvedLessThanOrEqualToCondition;

/**
 * A condition that is true if & only if a column equals a value
 */
class LessThanOrEqualToCondition extends Condition
{
    ...
    public function resolveFor(string $class): ResolvedCondition
    {
        ...
        return new ResolvedLessThanOrEqualToCondition($column, $value);
    }
}
